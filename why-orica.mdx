...
| ----------------------------- | ----------------------- | ----------------------- |
| Native in social platforms    | Yes: X and Telegram     | No                      |
| Instant on-chain escrow       | Yes: fully programmatic | Partial: varies         |
| Head-to-head wagers           | Yes                     | Sometimes               |
| Pooled counterparty option    | Yes                     | No                      |
| Separate spectator pool       | Yes: Sidebets           | No                      |
| Public leaderboard & tracking | Yes: social handles     | No                      |
| Automated oracle settlement   | Yes: built-in oracles   | Partial: varies         |
| Simple low transparent fees   | Yes: 1–2%               | No: often higher/hidden |
| Affiliate rewards             | Yes: 15% referral cut   | No                      |
| Token revenue sharing planned | Yes                     | No                      |
