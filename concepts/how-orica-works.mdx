...
<Steps>  
  <Step title="Step 1: Create a Wager">  
  ...
  <Step title="Step 2: Match the Wager">  
    ...
    <Warning>If no single counterparty appears, Orica can open a pooled match. Multiple users can collectively fill the opposing side, with stakes scaled and refunds issued instantly.</Warning>  
  </Step>  

  <Step title="Step 3: Sidebets for Spectators">  
    ...
    <Tip>Sidebets are independent of the main wager and carry their own 1% fee, with 20% flowing back to the primary winner as a bonus incentive.</Tip>  
  </Step>  

  <Step title="Step 4: Escrow & Settlement">  
    ...
    <Check>On Solana: Settlement is instant, transparent, and final.</Check>  
  </Step>  

  <Step title="Step 5: Payouts & Leaderboards">  
    ...
    <Info>Every win boosts your public score, so wagers aren’t just about money—they build social status.</Info>  
  </Step>  
</Steps>
